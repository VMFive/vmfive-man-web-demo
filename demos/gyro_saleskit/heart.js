(function () {
    ...
    function drawSvg(){
        // var svg = 'heartSVG';
        TweenMax.to('.icon',.3,{autoAlpha:0});
        TweenMax.to('.drawBox',0,{delay:.3,autoAlpha:1,onComplete:function(){
            const myVivus = new Vivus('heartSVG',{duration: 100},function(){
                playEnd();
            });
        }});
