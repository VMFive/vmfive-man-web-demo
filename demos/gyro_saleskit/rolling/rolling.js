(function () {
    ...
    function playroll(r1,r2,rollingrResult){
        ...
        .set('.rt1 .pic', { backgroundImage: 'url(./rolling/ppp'+ r1 + '.png' },.6)
        .set('.rt2 .pic', { backgroundImage: 'url(./rolling/ppp'+ r2 + '.png' },.6)
        .fromTo('.motion-in .bg', .6, { autoAlpha: 0, top: 30, backgroundImage: 'url(./rolling/p0'+rollingrResult+'.png' }, { autoAlpha: 1, top: 0 },'-=.2')
        .call(function () {
            isPlaying = false;
        })

            // .set('.rt1', { rotation:'-90deg',backgroundImage: 'url(./rolling/pp0' + rollingrResult + '-1.png' })
            // .set('.rt2', { rotation:'20deg',backgroundImage: 'url(./rolling/pp0' + rollingrResult + '-2.png' })
